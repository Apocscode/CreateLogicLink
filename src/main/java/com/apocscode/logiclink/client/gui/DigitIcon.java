...
/**
 * Digit display widget that renders a digit from the digit atlas with color tint.
 * Used to show axis values and gamepad index in the config screen.
 */
public class DigitIcon extends AbstractSimiWidget {
    ...
    public boolean isMouseOver(double mx, double my) {
        return this.visible && mx >= (double) this.getX() && my >= (double) this.getY()
                && mx < (double) (this.getX() + this.width) && my < (double) (this.getY() + this.height);
    }
